...
class TeachersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Row(
        children: [
          if (isDesktop) const SideNavBar(currentIndex: 2),
          Expanded(
                                    ...
                                    builder: (context, value, child) {
                                      return TextField(
                                        ...
                                        decoration: InputDecoration(
                                          hintText:
                                              'Search by teacher name or phone number...',
                                          prefixIcon: Icon(
                                            Icons.search,
                                            color: AppColors.darkRed,
                                          ),
                                ...
                                ElevatedButton.icon(
                                  onPressed: () {
                                    showDialog(
                                      context: context,
                                      builder: (context) =>
                                          const OnboardEditTeacherCard(),
                                      barrierDismissible: false,
                                    );
                                  },
                                  icon: const Icon(Icons.add),
                                  label: Text(
                                    isDesktop ? 'Onboard a new teacher' : 'Add',
                                  ),
      ...
      drawer: isDesktop
          ? null
          : const Drawer(child: SideNavBar(currentIndex: 2)),
    );
  }
}
