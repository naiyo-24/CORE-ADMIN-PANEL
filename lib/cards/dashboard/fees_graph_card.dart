...
class FeesGraphCard extends StatelessWidget {
  const FeesGraphCard({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(
                    'Monthly fees collected throughout the year',
          ...
          // Graph
          Obx(() {
            final data = dashboardController.monthlyFees;
