...
class TeacherPayoutGraphCard extends StatelessWidget {
  const TeacherPayoutGraphCard({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(
                    'Monthly salary disbursed to teachers',
          ...
          // Graph
          Obx(() {
            final data = dashboardController.monthlyTeacherPayout;
